#############################################################################
# Makefile for building: spectacle-ocr-screenshot
# Generated by qmake (3.1) (Qt 6.9.0)
# Project:  simple.pro
# Template: app
# Command: /usr/bin/qmake6 -o Makefile simple.pro
#############################################################################
...
CC            = gcc
CXX           = g++
DEFINES       = -DWITH_GZFILEOP -DQT_NO_DEBUG -DQT_WIDGETS_LIB -DQT_GUI_LIB -DQT_CORE_LIB
CFLAGS        = -pipe -O2 -Wall -Wextra -D_REENTRANT $(DEFINES)
CXXFLAGS      = -pipe -O2 -std=gnu++1z -Wall -Wextra -D_REENTRANT $(DEFINES)
INCPATH       = -I. -I/usr/include/leptonica -I/usr/include/libpng16 -I/usr/include/webp -I/usr/include/qt6 -I/usr/include/qt6/QtWidgets -I/usr/include/qt6/QtGui -I/usr/include/qt6/QtCore -I. -I/usr/lib64/qt6/mkspecs/linux-g++
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = spectacle-ocr-screenshot1.0.0
DISTDIR = /home/thomasw/GitRepos/spectacle-ocr-screenshot/.tmp/spectacle-ocr-screenshot1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1 -Wl,-rpath-link,/usr/lib64
LIBS          = $(SUBLIBS) -lZXing -ltesseract -L/usr/lib -lleptonica /usr/lib64/libQt6Widgets.so /usr/lib64/libQt6Gui.so /usr/lib64/libQt6Core.so -lpthread -lGLX -lOpenGL   
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
DIST          = /usr/lib64/qt6/mkspecs/features/spec_pre.prf \
		...
		simple.pro  main.cpp
QMAKE_TARGET  = spectacle-ocr-screenshot
DESTDIR       = 
...
spectacle-ocr-screenshot:  $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET)  $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: simple.pro /usr/lib64/qt6/mkspecs/linux-g++/qmake.conf /usr/lib64/qt6/mkspecs/features/spec_pre.prf \
		/usr/lib64/qt6/mkspecs/common/unix.conf \
		/usr/lib64/qt6/mkspecs/common/linux.conf \
		/usr/lib64/qt6/mkspecs/common/sanitize.conf \
		/usr/lib64/qt6/mkspecs/common/gcc-base.conf \
...
all: Makefile spectacle-ocr-screenshot
